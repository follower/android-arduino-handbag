...
NetworkHandbag::NetworkHandbag(EthernetServer& server) : server(server) {
  /*
   */
...
int NetworkHandbag::begin(BASIC_CALLBACK(setupUICallback)) {
...
boolean NetworkHandbag::isConnected() {
  /*
   */
