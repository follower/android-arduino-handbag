...
public class Activity_MainDisplay extends Activity implements ISetupActivity {
	...
	protected void onStart() {
		...
		bindSuccessful = bindService(new Intent(Activity_MainDisplay.this, HandbagWiFiCommsService.class), connCommsService, Context.BIND_AUTO_CREATE);
